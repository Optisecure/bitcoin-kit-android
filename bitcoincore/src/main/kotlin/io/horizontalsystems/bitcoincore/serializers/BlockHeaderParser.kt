...
open class BlockHeaderParser(val hasher: IHasher) {
    ...
    open fun parse(input: BitcoinInput): BlockHeader {
    ...
    protected fun serialize(version: Int, previousBlockHeaderHash: ByteArray, merkleRoot: ByteArray, timestamp: Long, bits: Long, nonce: Long): ByteArray {
